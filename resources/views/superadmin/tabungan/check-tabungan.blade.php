...
<head>
    ...
    <title>BANK MINI | Check Tabungan</title>
...
<body class="  ">
    ...
    <main class="main-content">
                ...
                <div class="col-md-12 col-lg-12">
                    <div class="overflow-hidden card aos-init aos-animate" data-aos="fade-up" data-aos-delay="600">
                        <div class="flex-wrap card-header d-flex justify-content-between">
                            ...
                            <button type="button" class="btn" data-bs-toggle="modal" data-bs-target="#popo"
        ...
        <div class="modal fade" id="popo" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Tambah Riwayat Pemasukan</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <form action="{{route('superadmin-tambahtab')}}" method="POST">
                            @csrf
                            <input hidden value="{{$users->nip_nisn}}" name="nip_nisn">
                            <div class="mb-3">
                                <label for="recipient-name" class="col-form-label">Pemasukan</label>
                                <input type="text" class="form-control" id="recipient-name" name="pemasukan">
                            </div>
                    </div>
