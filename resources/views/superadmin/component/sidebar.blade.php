                        ...
                        <div class="sidebar-body pt-0 data-scrollbar">
                            <div class="sidebar-list">
                                ...
                                <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link {{ Route::currentRoutename() == 'superadmin-beranda' ? ' active warna' : ''}}"
                                            aria-current="page" href="/superadmin-beranda">
                                            <i class="icon">
                                    ...
                                    <li class="nav-item">
                                        ...
                                        <ul class="sub-nav collapse" id="sidebar-user" data-bs-parent="#sidebar-menu">
                                            <li class="nav-item">
                                                <a class="nav-link {{ Route::currentRoutename() == 'superadmin-list-user' ? ' active warna' : ''}}"
                                                    aria-current="page" href="/superadmin-list-user">
                                                    <i class="icon">
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link {{ Route::currentRoutename() == 'superadmin-tambahkan-user' ? ' active warna' : ''}}"
                                                    aria-current="page" href="/superadmin-tambahkan-user">
                                                    <i class="icon">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="10"
                                                            viewBox="0 0 24 24" fill="currentColor">
                                                            <g>
                                    ...
                                    <li class="nav-item">
                                        ...
                                        <ul class="sub-nav collapse" id="sidebar-auth" data-bs-parent="#sidebar-menu">
                                            <li class="nav-item">
                                                <a class="nav-link {{ Route::currentRoutename() == 'superadmin-list-tabungan' ? ' active warna' : ''}}"
                                                    aria-current="page" href="/superadmin-list-tabungan"> <i
                                                        class="icon">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="10"
                                                            viewBox="0 0 24 24" fill="currentColor">
                                                            <g>
                                    ...
                                    <li class="nav-item">
                                        ...
                                        <ul class="sub-nav collapse" id="utilities-error"
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link {{ Route::currentRoutename() == 'superadmin-list-tarik-tunai' ? ' active warna' : ''}}"
                                                    aria-current="page" href="/superadmin-list-tarik-tunai"> <i
                                                        class="icon">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="10"
                                                            viewBox="0 0 24 24" fill="currentColor">
                                                            <g>
