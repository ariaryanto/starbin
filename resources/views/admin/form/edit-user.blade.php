                                ...
                                <form action="{{route('admin-update',$users->id)}}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        <div class="profile-img-edit position-relative">
                                            <img src="/images/{{ $users->image }}" alt="profile-image" class="theme-color-default-img profile-pic rounded avatar-100" id="img">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="role" name="role_id" class="selectpicker form-control" data-style="py-0">
                                ...
                                <div class="new-user-info">
                                    <div class="row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control" id="fname" placeholder="Nama" name="name" value="{{$users->name}}">
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label class="form-label" for="add2">Tanggal Kelahiran:</label>
                                            <input type="text" class="form-control vanila-datepicker" id="add2" placeholder="Tanggal Kelahiran" name="tanggal_lahir" value="{{date('d-m-Y', strtotime($users->tanggal_lahir))}}">
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label class="form-label" for="cname">Alamat:</label>
                                            <input type="text" class="form-control" id="cname" placeholder="Alamat" name="alamat" value="{{$users->alamat}}">
                                        </div>
                                        <div class="form-group col-sm-6">
                                            <label class="form-label">No Telepon:</label>
                                            <input type="text" class="form-control" id="cname" placeholder="No Telepon" name="no_telepon" value="{{$users->no_telepon}}">

                                        </div>
                                        <div class="form-group col-md-12">
                                            <label class="form-label" for="mobno">Email:</label>
                                            <input type="email" class="form-control" id="mobno" placeholder="Email" name="email" value="{{$users->email}}">
                                        </div>
                                        <div class="form-group col-md-12">
                                            <label class="form-label" for="altconno">NIP / NISN:</label>
                                            <input type="text" class="form-control" id="altconno" placeholder="NIP / NISN" name="nip_nisn" value="{{$users->nip_nisn}}">
                                        </div>
                                        <div class="form-group col-md-12">
                                            <label class="form-label" for="pno">Password:</label>
                                            <input type="text" class="form-control" id="pno" placeholder="Isi kolom ini jika anda ingin ganti Password." name="password">
                                        </div>
                                    </div>
                                    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modals">Edit</button>
                                </div>
                            </div>
                        </div>
                    </div>
