...
<head>
    ...
    <title>BANK MINI | Tambahkan User</title>
                                ...
                                <form action="{{ route('admin-store') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        <div class="profile-img-edit position-relative">
                                            <img src="{{asset('assets/images/avatars/01.png')}}" alt="profile-image"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="role" name="role_id" class="selectpicker form-control"
                                            data-style="py-0">
                                            <option>Pilih</option>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-12">
                                            ...
                                            <input type="text" class="form-control" id="altconno"
                                                placeholder="NIP / NISN" name="nip_nisn">
                                        </div>
                                        <div class="form-group col-md-12">
                                            <label class="form-label" for="pno">Password:</label>
                                            <input type="text" class="form-control" id="pno" placeholder="Password"
                                                name="password">
                                        </div>
                                    </div>
                                    <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                        data-bs-target="#modals">Tambahkan</button>
                                </div>
                            </div>
                        </div>
                    </div>
